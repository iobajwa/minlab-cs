...
namespace MiniLab.UnitTests.Device.MiniLab
{
    ...
    {
        Mock<IHIDFinder> _mockFinder;

        [SetUp]
        public void __Setup()
        {
            _mockFinder = new Mock<IHIDFinder>(MockBehavior.Strict);
        }

        [TearDown]
        public void __VerifyMocks()
        {
            _mockFinder.VerifyAll();
        }
    ...
    internal class MiniLabDeviceTestsBase
    {
        ...
        protected Mock<IHIDDevice> _mockDevice;
        protected Mock<IHIDFinder> _mockFinder;
    
        [SetUp]
        public void __Setup()
        {
            _mockDevice = new Mock<IHIDDevice>(MockBehavior.Strict);
            _CreateANewMiniLabDeviceInstance();
        }

        [TearDown]
        public void __VerifyMocks()
        {
            _mockDevice.VerifyAll();
        }
